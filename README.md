...
- **Unified context assembly** — searches Knowledge Bases and Memory in parallel, cross-ranks results via an LLM listwise reranker with sufficiency evaluation, and automatically escalates to deep research when context is insufficient — all within a shared token budget
...
- **[docs/UNIFIED_KNOWLEDGE_LAYER_DESIGN.md](docs/UNIFIED_KNOWLEDGE_LAYER_DESIGN.md)** — unified context assembly layer design (parallel KB + Memory retrieval, LLM reranker, sufficiency evaluation, deep escalation)
