...
const ALL_SCOPES: KBScope[] = ["chat", "create_job", "plan_job", "agent_task", "all"];
            ...
            <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginTop: 4 }}>
              {ALL_SCOPES.map((scope) => (
                <button
                  ...
                  style={{
                    ...css.btnSmall,
                    background: editScopes.includes(scope) ? "var(--accent)" : "var(--bg3)",
                    color: editScopes.includes(scope) ? "#fff" : "var(--fg2)",
                    border: editScopes.includes(scope)
